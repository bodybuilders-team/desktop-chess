...
fun Board.isValidMove(move: Move) : Boolean{
    val piece = getPieceOrThrows(move.from)
    return isValidMove(piece, move)
}
 ...
 * if the move symbol is invalid
 */
fun Board.isValidMove(piece: Piece, move: Move): Boolean {
 ...
 */
fun Board.areKingsInCheck(army: Color){
